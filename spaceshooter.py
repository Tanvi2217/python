...
enemyShootSound = pygame.mixer.Sound("assets/sound_1.wav")
myShipShootSound = pygame.mixer.Sound("assets/sound_2.wav")
bgImage = pygame.image.load("assets/background.jpg")
fontPath = "assets/sf-atarian-system.bold.ttf"
...
def showHealth():
    font_3 = pygame.font.Font(fontPath, 60)
    text_3 = font_3.render("GAME OVER", True, black)
    screen.fill(white)
    screen.blit(text_3, (250,250))
    while True:
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                pygame.quit()  # quit pygame
...
def game():
    ...
    myShip = pygame.image.load("assets/ship_1.png")
    enemyShip = pygame.image.load("assets/enemy_2.png")
